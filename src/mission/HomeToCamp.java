...
public class HomeToCamp extends JFrame
{
	...
	public static void main(String[] args)
	{
		EventQueue.invokeLater(new Runnable()
		{
			public void run()
			{
				try
				{
					HomeToCamp frame = new HomeToCamp();
	 ...
	 * @throws SQLException 
	 */
	public HomeToCamp() throws SQLException
	{
		...
		JLabel lblHomeToCamp = new JLabel("Home To Camp");
		lblHomeToCamp.setFont(new Font("Tahoma", Font.PLAIN, 20));
		lblHomeToCamp.setBounds(90, 11, 158, 25);
		contentPane.add(lblHomeToCamp);
