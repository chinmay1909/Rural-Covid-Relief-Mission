...
public class UpdateAdmit extends JFrame
{
    ...
    public static void main(String[] args)
    {
        EventQueue.invokeLater(() -> {
            try
            {
                UpdateAdmit frame = new UpdateAdmit();
     ...
     * @throws SQLException
     */
    public UpdateAdmit() throws SQLException
    {
        ...
        JLabel lblUpdateAdmitStatus = new JLabel("Admit Details");
        lblUpdateAdmitStatus.setFont(new Font("Tahoma", Font.PLAIN, 20));
        lblUpdateAdmitStatus.setBounds(124, 11, 222, 25);
        contentPane.add(lblUpdateAdmitStatus);

        ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("mission/icons/nine.jpg"));
        ...
        JLabel lblNewLabel_1 = new JLabel("Tent Number :");
        ...
        JLabel lblNewLabel_3 = new JLabel("Admitted :");
        ...
        btnUpdate.addActionListener(new ActionListener()
        {
            public void actionPerformed(ActionEvent ae)
            {
                try
                {
                    ...
                    String s2 = txt_ID.getText(); //tent_number;
                    String s3 = txt_Status.getText(); //name
                    String s4 = txt_Date.getText(); //status;
                    String s5 = txt_Time.getText(); //deposit

                    c.s.executeUpdate("update patient set tent_number = '"+s2+"', name = '"+s3+"', status = '"+s4+"', deposit = '"+s5+"' where number = '"+s1+"'");
        ...
        btnAdd.addActionListener(new ActionListener()
        {
            public void actionPerformed(ActionEvent e)
            {
                try {
                    ...
                    while (rs1.next()) {
                        txt_ID.setText(rs1.getString("tent_number"));
                ...
                try
                {
                    String total = "";
                    conn c = new conn();
                    ResultSet rs2 = c.s.executeQuery("select * from tent where tent_number = '" + txt_ID.getText() + "'");
                    while (rs2.next())
                    {
