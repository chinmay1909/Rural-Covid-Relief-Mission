...
public class AddEmployee extends JFrame
{
	...
	public AddEmployee()
    {
        ...
        add(Address);
        String course[] = {"ENT Specialist","Doctor","Physical Therapist","Lab Technician","Dietician","Pharmacist","Nurse","Cleaner","Manager","Accountant","Assistant"};
        ...
        add(textField_6);
        setVisible(true);
        JLabel AddPass = new JLabel("ADD EMPLOYEE DETAILS");
        AddPass.setForeground(Color.BLUE);
        AddPass.setFont(new Font("Tahoma", Font.PLAIN, 31));
        AddPass.setBounds(450, 24, 442, 35);
        add(AddPass);
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("mission/icons/tenth.jpg"));
        ...
        Next.addActionListener(new ActionListener()
        {
            public void actionPerformed(ActionEvent ae)
            {
                ...
                {
                    conn c = new conn();
                    String str = "INSERT INTO employee values( '"+name+"', '"+age+"', '"+gender+"','"+s6+"', '"+salary+"', '"+phone+"','"+aadhaar+"', '"+email+"')";
